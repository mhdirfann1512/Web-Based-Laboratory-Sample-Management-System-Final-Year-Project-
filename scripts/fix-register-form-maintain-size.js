    ...
    <script>
        ...
        function printLabel() {
            ...
            const htmlContent = '<!DOCTYPE html>' +
                ...
                '.sample-id { font-size: 24px; font-weight: bold; margin: 10px 0; font-family: "Courier New", monospace; letter-spacing: 2px; }' +
                ...
                '<div class="info"><strong>Storage:</strong> ' + freezerName + '</div>' +
                '<div class="info">' + tempRange + '</div>' +
                '<div class="date">Registered: ' + new Date().toLocaleDateString() + '</div>' +
                '</div>' +
                '<script>' +
...
try {
  ...
  console.log("✅ Register sample form updated successfully!")
  console.log("📋 Changes made:")
  console.log("   • Maintained original font sizes and padding")
  console.log("   • Created 3-column layout that fits on one screen")
  console.log("   • Used full viewport height efficiently")
  console.log("   • Kept all functionality intact")
  console.log("   • Made form responsive for different screen sizes")
  console.log("   • Success display now uses full-screen overlay")
} catch (error) {
  console.error("❌ Error updating register sample form:", error)
}
